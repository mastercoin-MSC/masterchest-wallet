...
Module Module1
    ...
    Public Sub deselectlabels()
        ...
        Form1.bsettings.ForeColor = Color.FromArgb(100, 100, 100)
    ...
    Public Sub activatesettings()
        deselectlabels()
        Form1.bsettings.ForeColor = Color.FromArgb(209, 209, 209)
        hidepanels()
